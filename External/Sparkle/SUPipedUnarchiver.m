...
- (void)extractArchivePipingDataToCommand:(NSString *)command
{
	...
	// Get the file size.
	 ...
	 [[[NSFileManager defaultManager] fileAttributesAtPath:archivePath traverseLink:NO] objectForKey:NSFileSize];
#else
	 [[[NSFileManager defaultManager] attributesOfItemAtPath:archivePath error:nil] objectForKey:NSFileSize];
#endif
